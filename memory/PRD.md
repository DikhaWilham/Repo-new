...
- 2026-09-22: Login wajib (semua rute diproteksi; rute tak dikenal → / → /login) + PWA installable. Tambah komponen InstallPWA (data-testid install-app-button) di header Dashboard & halaman Login: prompt native untuk PC (Chrome/Edge) & Android, panduan "Tambah ke Layar Utama" untuk iOS. Manifest/SW/icons terverifikasi 200
